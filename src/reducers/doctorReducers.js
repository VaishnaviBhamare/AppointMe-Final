const {
 ...
 DOCTOR_REVIEW_CREATE_RESET,
  ...
  export const doctorReviewCreateReducer = (state = {}, action) => {
    switch (action.type) {
      case DOCTOR_REVIEW_CREATE_REQUEST:
        return { loading: true };
      case DOCTOR_REVIEW_CREATE_SUCCESS:
        return { loading: false, success: true, review: action.payload };
      case DOCTOR_REVIEW_CREATE_FAIL:
        return { loading: false, error: action.payload };
      case DOCTOR_REVIEW_CREATE_RESET:
        return {};
      default:
        return state;
    }
