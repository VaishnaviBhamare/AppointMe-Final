...
export const DOCTOR_REVIEW_CREATE_REQUEST = 'DOCTOR_REVIEW_CREATE_REQUEST';
export const DOCTOR_REVIEW_CREATE_SUCCESS = 'DOCTOR_REVIEW_CREATE_SUCCESS';
export const DOCTOR_REVIEW_CREATE_FAIL = 'DOCTOR_REVIEW_CREATE_FAIL';
export const DOCTOR_REVIEW_CREATE_RESET = 'DOCTOR_REVIEW_CREATE_RESET';
